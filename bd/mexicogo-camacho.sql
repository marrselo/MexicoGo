...
--
-- Host: localhost    Database: mexigo
-- ------------------------------------------------------
...
CREATE TABLE `properties` (
  ...
  KEY `fk_properties_property_listing_status1_idx` (`properties_buildings_rel_id`),
  ...
  CONSTRAINT `fk_properties_property_listing_status1` FOREIGN KEY (`properties_buildings_rel_id`) REFERENCES `property_listing_status` (`properties_buildings_rel_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `property_listing_status` (
  `properties_buildings_rel_id` int(11) NOT NULL AUTO_INCREMENT,
  `properties_buildings_rel_name` char(200) COLLATE utf8_spanish_ci DEFAULT NULL,
  PRIMARY KEY (`properties_buildings_rel_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `property_listing_status`
--

LOCK TABLES `property_listing_status` WRITE;
/*!40000 ALTER TABLE `property_listing_status` DISABLE KEYS */;
/*!40000 ALTER TABLE `property_listing_status` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50001 CREATE TABLE `view_core_usuarios_partner` (
  ...
  `usu_nombre` tinyint NOT NULL,
  `usu_apellidos` tinyint NOT NULL,
  `usu_nick` tinyint NOT NULL,
  `usu_contrasena` tinyint NOT NULL,
  `usu_celular` tinyint NOT NULL,
  `usu_telefono` tinyint NOT NULL,
  `usu_correo` tinyint NOT NULL,
  `usu_creacion_fec` tinyint NOT NULL,
  `usu_img` tinyint NOT NULL,
  `usu_id_estado` tinyint NOT NULL,
  `grupo_usuario` tinyint NOT NULL,
  `par_id` tinyint NOT NULL,
  `par_nickname` tinyint NOT NULL,
  `par_email` tinyint NOT NULL,
  `par_full_name` tinyint NOT NULL,
  `par_chief` tinyint NOT NULL,
  `par_flag_customer` tinyint NOT NULL,
  `par_acount_type_id` tinyint NOT NULL,
  `par_flag_partner_profiler` tinyint NOT NULL,
  `par_other_type_account_id` tinyint NOT NULL,
  `par_state` tinyint NOT NULL
) ENGINE=MyISAM */;
...
-- Dump completed on 2012-09-05 19:14:42
