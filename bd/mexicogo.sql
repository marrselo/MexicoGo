CREATE DATABASE  IF NOT EXISTS `mexigo` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `mexigo`;
-- MySQL dump 10.13  Distrib 5.5.16, for Win32 (x86)
--
-- Host: 127.0.0.1    Database: mexigo
-- ------------------------------------------------------
...
--
-- Dumping data for table `mexi_banners_position`
--

LOCK TABLES `mexi_banners_position` WRITE;
/*!40000 ALTER TABLE `mexi_banners_position` DISABLE KEYS */;
INSERT INTO `mexi_banners_position` VALUES (1,'Half Banner'),(2,'Leaderboard'),(3,'Medium Rectangle'),(4,'Slideshow Banner');
/*!40000 ALTER TABLE `mexi_banners_position` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `core_calendarios`
--

LOCK TABLES `core_calendarios` WRITE;
/*!40000 ALTER TABLE `core_calendarios` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_calendarios` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `core_roles_acl_cat`
--

LOCK TABLES `core_roles_acl_cat` WRITE;
/*!40000 ALTER TABLE `core_roles_acl_cat` DISABLE KEYS */;
INSERT INTO `core_roles_acl_cat` VALUES (2,'Brokerage Account'),(4,'Other Partner'),(3,'Real Estate Development'),(1,'Single Real Estate Agent');
/*!40000 ALTER TABLE `core_roles_acl_cat` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `partner_imgs`
--

LOCK TABLES `partner_imgs` WRITE;
/*!40000 ALTER TABLE `partner_imgs` DISABLE KEYS */;
/*!40000 ALTER TABLE `partner_imgs` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `mexi_informative_pages`
--

LOCK TABLES `mexi_informative_pages` WRITE;
/*!40000 ALTER TABLE `mexi_informative_pages` DISABLE KEYS */;
/*!40000 ALTER TABLE `mexi_informative_pages` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `mexi_banners`
--

LOCK TABLES `mexi_banners` WRITE;
/*!40000 ALTER TABLE `mexi_banners` DISABLE KEYS */;
INSERT INTO `mexi_banners` VALUES (1,NULL,1,'Half Banner 234 x 60',1),(2,NULL,1,'Leaderboard 728 x 90',2),(3,NULL,1,'Medium Rectangle 300 x 250t',3),(4,NULL,1,'Slideshow Banner 728 x 90',4),(5,NULL,2,'Half Banner 234 x 60',1),(6,NULL,2,'Leaderboard 728 x 90',2),(7,NULL,2,'Medium Rectangle 300 x 250t',3),(8,NULL,2,'Slideshow Banner 728 x 90',4);
/*!40000 ALTER TABLE `mexi_banners` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `core_set_info_abaut_usuario`
--

LOCK TABLES `core_set_info_abaut_usuario` WRITE;
/*!40000 ALTER TABLE `core_set_info_abaut_usuario` DISABLE KEYS */;
INSERT INTO `core_set_info_abaut_usuario` VALUES (1,1,31),(2,2,31),(3,3,31),(4,4,31);
/*!40000 ALTER TABLE `core_set_info_abaut_usuario` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `mexi_partners_packages_cat`
--

LOCK TABLES `mexi_partners_packages_cat` WRITE;
/*!40000 ALTER TABLE `mexi_partners_packages_cat` DISABLE KEYS */;
/*!40000 ALTER TABLE `mexi_partners_packages_cat` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `core_privilegios_acl_cat`
--

LOCK TABLES `core_privilegios_acl_cat` WRITE;
/*!40000 ALTER TABLE `core_privilegios_acl_cat` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_privilegios_acl_cat` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `partners` VALUES (28,31,'nazartj@gmail.com','nazartj@gmail.com',NULL,NULL,2,NULL,NULL,NULL,0),(29,32,'nazartj@12aoms.com','nazartj@12aoms.com',NULL,NULL,2,NULL,NULL,NULL,0),(30,33,'nazartj@aoms.com','nazartj@aoms.com',NULL,NULL,2,NULL,NULL,NULL,0),(31,34,'nazartjarahuaman@gmail.com','nazartjarahuaman@gmail.com',NULL,NULL,2,NULL,NULL,NULL,1);
...
INSERT INTO `type_region` VALUES (1,'City'),(2,'Country'),(3,'State/Province');
...
--
-- Dumping data for table `core_log_prioridad_cat`
--

LOCK TABLES `core_log_prioridad_cat` WRITE;
/*!40000 ALTER TABLE `core_log_prioridad_cat` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_log_prioridad_cat` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `partner_payment`
--

LOCK TABLES `partner_payment` WRITE;
/*!40000 ALTER TABLE `partner_payment` DISABLE KEYS */;
INSERT INTO `partner_payment` VALUES (1,'adssdd','asdasd','123-123-123','','','','',NULL,'',31,NULL);
/*!40000 ALTER TABLE `partner_payment` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `single_agent_packages_partner`
--

LOCK TABLES `single_agent_packages_partner` WRITE;
/*!40000 ALTER TABLE `single_agent_packages_partner` DISABLE KEYS */;
/*!40000 ALTER TABLE `single_agent_packages_partner` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `partners_acount_type`
--

LOCK TABLES `partners_acount_type` WRITE;
/*!40000 ALTER TABLE `partners_acount_type` DISABLE KEYS */;
INSERT INTO `partners_acount_type` VALUES (1,'Single Real Estate Agent','Single Real Estate Agent'),(2,'Brokerage Account','Brokerage Account'),(3,'Real Estate Development','Real Estate Development');
/*!40000 ALTER TABLE `partners_acount_type` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `core_parametros`
--

LOCK TABLES `core_parametros` WRITE;
/*!40000 ALTER TABLE `core_parametros` DISABLE KEYS */;
INSERT INTO `core_parametros` VALUES (1,NULL,'PriceFeatureListingsSinglePartner',NULL,'5',NULL,NULL,NULL,NULL,NULL,NULL,'PriceFeatureListingsSinglePartner');
...
--
-- Dumping data for table `properties_favorites`
--

LOCK TABLES `properties_favorites` WRITE;
/*!40000 ALTER TABLE `properties_favorites` DISABLE KEYS */;
/*!40000 ALTER TABLE `properties_favorites` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `properties_buildings_rel`
--

LOCK TABLES `properties_buildings_rel` WRITE;
/*!40000 ALTER TABLE `properties_buildings_rel` DISABLE KEYS */;
/*!40000 ALTER TABLE `properties_buildings_rel` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `single_agent_packages`
--

LOCK TABLES `single_agent_packages` WRITE;
/*!40000 ALTER TABLE `single_agent_packages` DISABLE KEYS */;
INSERT INTO `single_agent_packages` VALUES (1,'pakage1',1,10,10),(2,'pakage1',5,40,8),(3,'pakage1',10,60,6),(4,'pakage1',20,100,5);
/*!40000 ALTER TABLE `single_agent_packages` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `core_set_info_abaut`
--

LOCK TABLES `core_set_info_abaut` WRITE;
/*!40000 ALTER TABLE `core_set_info_abaut` DISABLE KEYS */;
INSERT INTO `core_set_info_abaut` VALUES (1,'All Mexi-Go! Packages'),(2,'Packages for Businesses'),(3,'Brokerage packages'),(4,'Real estate listings'),(5,'Online ads (Banners)'),(6,'Print magazine'),(7,'Online-magazine');
/*!40000 ALTER TABLE `core_set_info_abaut` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `mexi_banners_type`
--

LOCK TABLES `mexi_banners_type` WRITE;
/*!40000 ALTER TABLE `mexi_banners_type` DISABLE KEYS */;
INSERT INTO `mexi_banners_type` VALUES (1,'HomePage'),(2,'InternaPage');
/*!40000 ALTER TABLE `mexi_banners_type` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `core_estados`
--

LOCK TABLES `core_estados` WRITE;
/*!40000 ALTER TABLE `core_estados` DISABLE KEYS */;
INSERT INTO `core_estados` VALUES (1,'Aguascalientes',''),(2,'Baja California',''),(3,'Baja California Sur',''),(4,'Campeche',''),(5,'Coahuila',''),(6,'Colima',''),(7,'Chiapas',''),(8,'Chihuahua',''),(9,'Distrito Federal',''),(10,'Durango',''),(11,'Guanajuato',''),(12,'Guerrero',''),(13,'Hidalgo',''),(14,'Jalisco',''),(15,'México',''),(16,'Michoacán',''),(17,'Morelos',''),(18,'Nayarit',''),(19,'Nuevo León',''),(20,'Oaxaca',''),(21,'Puebla',''),(22,'Querétaro',''),(23,'Quintana Roo',''),(24,'San Luis Potosí',''),(25,'Sinaloa',''),(26,'Sonora',''),(27,'Tabasco',''),(28,'Tamaulipas',''),(29,'Tlaxcala',''),(30,'Veracruz',''),(31,'Yucatán',''),(32,'Zacatecas','');
/*!40000 ALTER TABLE `core_estados` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `partners_categories_rel`
--

LOCK TABLES `partners_categories_rel` WRITE;
/*!40000 ALTER TABLE `partners_categories_rel` DISABLE KEYS */;
INSERT INTO `partners_categories_rel` VALUES (2,31,2),(3,31,3),(4,31,4);
/*!40000 ALTER TABLE `partners_categories_rel` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `core_recursos_acl_cat`
--

LOCK TABLES `core_recursos_acl_cat` WRITE;
/*!40000 ALTER TABLE `core_recursos_acl_cat` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_recursos_acl_cat` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `core_roles_recursos_privilegios_rel`
--

LOCK TABLES `core_roles_recursos_privilegios_rel` WRITE;
/*!40000 ALTER TABLE `core_roles_recursos_privilegios_rel` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_roles_recursos_privilegios_rel` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `partner_billing`
--

LOCK TABLES `partner_billing` WRITE;
/*!40000 ALTER TABLE `partner_billing` DISABLE KEYS */;
/*!40000 ALTER TABLE `partner_billing` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `partner_profile` DISABLE KEYS */;
INSERT INTO `partner_profile` VALUES (1,31,NULL,'nazart jara huaman asd','nazartjb@gsmil.com','www.google.com','123-123-123','123-123-123','nazart jara huaman asd asdadasd asdasdaasdas                                                                                                                                                                                                                                                                                             ','phone','phone','123-66-5','phone');
/*!40000 ALTER TABLE `partner_profile` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `partner_location`
--

LOCK TABLES `partner_location` WRITE;
/*!40000 ALTER TABLE `partner_location` DISABLE KEYS */;
INSERT INTO `partner_location` VALUES (14,31,'asdasdasd','asdasdasd',NULL,NULL,17,0,'asdasd','asdasd','asdasdads');
/*!40000 ALTER TABLE `partner_location` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `partners_categories` VALUES (1,'Real estate',NULL),(2,'Travel',NULL),(3,'Retirement',NULL),(4,'Living',NULL),(5,'Parteners',NULL);
...
--
-- Dumping data for table `properties_features_rel`
--

LOCK TABLES `properties_features_rel` WRITE;
/*!40000 ALTER TABLE `properties_features_rel` DISABLE KEYS */;
/*!40000 ALTER TABLE `properties_features_rel` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `partner_other_type_account`
--

LOCK TABLES `partner_other_type_account` WRITE;
/*!40000 ALTER TABLE `partner_other_type_account` DISABLE KEYS */;
INSERT INTO `partner_other_type_account` VALUES (1,'Banking',NULL),(2,'Beauty Salons',NULL),(3,'Airline',NULL),(4,'Construccion / renoval',NULL),(5,'Cosmetic surgery',NULL),(6,'Fashion and retail',NULL),(7,'Property management',NULL);
/*!40000 ALTER TABLE `partner_other_type_account` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `properties_amenities_rel`
--

LOCK TABLES `properties_amenities_rel` WRITE;
/*!40000 ALTER TABLE `properties_amenities_rel` DISABLE KEYS */;
/*!40000 ALTER TABLE `properties_amenities_rel` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `properties` (
  ...
  `pro_listing_status` varchar(45) DEFAULT NULL,
  `pro_type` varchar(45) DEFAULT NULL,
  `pro_price` decimal(10,2) DEFAULT NULL,
  `pro_house_m2` int(11) DEFAULT NULL,
  `pro_land_ms` int(11) DEFAULT NULL,
  `reg_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `agent_profile_page`
--

LOCK TABLES `agent_profile_page` WRITE;
/*!40000 ALTER TABLE `agent_profile_page` DISABLE KEYS */;
/*!40000 ALTER TABLE `agent_profile_page` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `view_core_usuarios_partner`
--
...
/*!50001 CREATE TABLE `view_core_usuarios_partner` (
  ...
  `usu_apellidos` varchar(255),
  `usu_nick` varchar(50),
  `usu_contrasena` varchar(150),
  `usu_celular` varchar(15),
  `usu_telefono` varchar(15),
  `usu_correo` varchar(120),
  `usu_creacion_fec` datetime,
  `usu_img` varchar(255),
  `usu_id_estado` tinyint(4),
  `grupo_usuario` varchar(7),
  `par_id` int(11),
  `par_nickname` varchar(45),
  `par_email` varchar(45),
  `par_full_name` varchar(45),
  `par_chief` int(11),
  `par_flag_customer` tinyint(1),
  `par_acount_type_id` int(11),
  `par_flag_partner_profiler` tinyint(1),
  `par_other_type_account_id` int(11),
  `par_state` tinyint(4)
) ENGINE=MyISAM */;
...
--
-- Dumping data for table `partners_subcategories`
--

LOCK TABLES `partners_subcategories` WRITE;
/*!40000 ALTER TABLE `partners_subcategories` DISABLE KEYS */;
/*!40000 ALTER TABLE `partners_subcategories` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `core_transacciones`
--

LOCK TABLES `core_transacciones` WRITE;
/*!40000 ALTER TABLE `core_transacciones` DISABLE KEYS */;
/*!40000 ALTER TABLE `core_transacciones` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `mexi_banners_partners`
--

LOCK TABLES `mexi_banners_partners` WRITE;
/*!40000 ALTER TABLE `mexi_banners_partners` DISABLE KEYS */;
/*!40000 ALTER TABLE `mexi_banners_partners` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `partners_subcategories_rel`
--

LOCK TABLES `partners_subcategories_rel` WRITE;
/*!40000 ALTER TABLE `partners_subcategories_rel` DISABLE KEYS */;
INSERT INTO `partners_subcategories_rel` VALUES (31,10,3),(31,11,1);
/*!40000 ALTER TABLE `partners_subcategories_rel` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `partner_packages_informative`
--

LOCK TABLES `partner_packages_informative` WRITE;
/*!40000 ALTER TABLE `partner_packages_informative` DISABLE KEYS */;
INSERT INTO `partner_packages_informative` VALUES (1,'SILVER PACKAGE','informacion del paquete SILVER PACKAGE','informacion del paquete SILVER PACKAGE','BROKERAGE'),(2,'GOLD PACKAGE','informacion del paquete GOLD PACKAGE','informacion del paquete GOLD PACKAGE','BROKERAGE'),(3,'DIAMOND PACKAGE','informacion del paquete DIAMOND PACKAGE','informacion del paquete DIAMOND PACKAGE','BROKERAGE'),(4,'BASIC PARTNERSHIP','informacion del paquete BASIC PARTNERSHIP','informacion del paquete BASIC PARTNERSHIP','PARTNERSHIP'),(5,'SMALL BUSINESS PARTNERSHIP','informacion del paquete SMALL BUSINESS PARTNERSHIP','informacion del paquete SMALL BUSINESS PARTNERSHIP','PARTNERSHIP'),(6,'SILVER PARTNERSHIP','informacion del paquete SILVER PARTNERSHIP','informacion del paquete SILVER PARTNERSHIP','PARTNERSHIP'),(7,'GOLD PARTNERSHIP','informacion del paquete GOLD PARTNERSHIP','informacion del paquete GOLD PARTNERSHIP','PARTNERSHIP'),(8,'DIAMOND PARTNERSHIP','informacion del paquete DIAMOND PARTNERSHIP','informacion del paquete DIAMOND PARTNERSHIP','PARTNERSHIP');
/*!40000 ALTER TABLE `partner_packages_informative` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `partner_videos` DISABLE KEYS */;
INSERT INTO `partner_videos` VALUES (165,NULL,'Youtube',NULL,31,'http://www.youtube.com/watch?v=iOrCQ7vVmP8&feature=g-all-esi'),(166,NULL,'Youtube',NULL,31,'http://www.youtube.com/watch?v=TtAUr2-DBLk&feature=fvwrel');
/*!40000 ALTER TABLE `partner_videos` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `properties_appliances_rel`
--

LOCK TABLES `properties_appliances_rel` WRITE;
/*!40000 ALTER TABLE `properties_appliances_rel` DISABLE KEYS */;
/*!40000 ALTER TABLE `properties_appliances_rel` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `partner_files` DISABLE KEYS */;
INSERT INTO `partner_files` VALUES (7,'NAZAR001','fileProfiler1_31.pdf',NULL,31);
/*!40000 ALTER TABLE `partner_files` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `agent_location` DISABLE KEYS */;
/*!40000 ALTER TABLE `agent_location` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `partner_package_available`
--

LOCK TABLES `partner_package_available` WRITE;
/*!40000 ALTER TABLE `partner_package_available` DISABLE KEYS */;
/*!40000 ALTER TABLE `partner_package_available` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Final view structure for view `view_core_usuarios_partner`
--
...
-- Dump completed on 2012-09-04 19:09:19
