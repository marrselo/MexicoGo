...
CREATE TABLE `properties` (
  ...
  `source_img` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `title_img` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
  `publish` tinyint(1) unsigned DEFAULT '0' COMMENT '1 publish    /  0 unpublish',
  PRIMARY KEY (`pro_id`),
...
insert  into `property_videos`(`vid_id`,`pro_id`,`vid_uri`,`vid_type`,`vid_order`) values (66,5,'http://www.youtube.com/watch?v=SGsCXP1HwwY&feature=g-vrec','youtube',NULL),(67,5,'http://www.youtube.com/watch?v=SGsCXP1HwwY&feature=g-vrec','youtube',NULL);
...
/* Trigger structure for table `property_imgs` */

DELIMITER $$

/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `TG_MG_SourceImg` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `TG_MG_SourceImg` AFTER INSERT ON `property_imgs` FOR EACH ROW BEGIN 
    IF NEW.img_order = 1 THEN 
        UPDATE properties SET source_img = NEW.img_source, title_img = NEW.img_title
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `TG_MG_UpdateImg` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `TG_MG_UpdateImg` AFTER UPDATE ON `property_imgs` FOR EACH ROW BEGIN 
    IF NEW.img_order = 1 THEN 
        UPDATE properties SET source_img = NEW.img_source, title_img = NEW.img_title
            WHERE pro_id = NEW.pro_id;
    END IF;
