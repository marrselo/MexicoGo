            ...
            <div id="central-content">
                    ...
                    <section id="block-right">
                        <form id="real-state-listing-page" class="form-account-setting">
                            ...
                            <hr class="hr-gris"/>
                            <fieldset id="upload-image"><legend class="oswald">SELECT PHOTOS TO EDIT...</legend>
                                            ...
                                            <li>
                                                <div class="box">
                                                    <div class="frame-photo">
                                                        <img src="images/property1.jpg" title="" alt="" />
                                                    </div>
                                                    <label class="title">Screen shot 2012-06-07 at...</label>
                                                    <p class="description"> Add a description</p>
                                                </div>
                                            </li>
                                            <li>
